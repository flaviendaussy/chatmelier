...
const List<RegionVin> regionsFrance = [
  ...
  RegionVin(
    ...
    nom: 'Pomerol & Lalande',
    elevages: {'red': Elevage(ContenantElevage.barrique, 18)},
    alias: ['pomerol', 'lalande-de-pomerol', 'lalande de pomerol', 'fronsac'],
    cepages: ['Merlot', 'Cabernet Franc'],
  ...
  RegionVin(
    ...
    nom: 'Côte de Nuits',
    elevages: {'red': Elevage(ContenantElevage.barrique, 16)},
    alias: ['gevrey-chambertin', 'chambolle-musigny', 'vosne-romanee',
  ...
  RegionVin(
    ...
    alias: ['pommard', 'volnay', 'beaune', 'meursault', 'puligny-montrachet',
      ...
      'saint-aubin', 'santenay', 'cote de beaune'],
  ...
  RegionVin(
    ...
    alias: ['bourgogne hautes cotes', 'hautes cotes', 'coteaux bourguignons',
      'bourgogne aligote', 'passetoutgrain', 'bourgogne'],
  ...
  RegionVin(
    ...
    alias: ['cote-rotie', 'hermitage', 'crozes-hermitage', 'cornas',
      'saint-joseph', 'saint-peray'],
