...
class BarPantryService {
  ...
  static final List<BarPantryItem> defaultTemplate = [
    ...
    const BarPantryItem(id: 'ft_elderflower_tonic', name: 'Fever-Tree Elderflower Tonic', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🌸'),
    const BarPantryItem(id: 'ft_light_tonic', name: 'Fever-Tree Refreshingly Light Tonic', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🫧'),
    const BarPantryItem(id: 'ft_aromatic_tonic', name: 'Fever-Tree Aromatic Tonic', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🌿'),
    const BarPantryItem(id: 'ft_clementine_tonic', name: 'Fever-Tree Clementine & Cinnamon Tonic', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🍊'),
    const BarPantryItem(id: 'ft_rhubarb_tonic', name: 'Fever-Tree Rhubarb & Raspberry Tonic', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🍇'),
    const BarPantryItem(id: 'ft_cucumber_tonic', name: 'Fever-Tree Cucumber Tonic Water', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🥒'),
    const BarPantryItem(id: 'ft_pink_grapefruit_soda', name: 'Fever-Tree Sparkling Pink Grapefruit', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🍈'),
    const BarPantryItem(id: 'ginger_beer', name: 'Ginger Beer épicée', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🍺'),
    const BarPantryItem(id: 'ft_ginger_beer', name: 'Fever-Tree Premium Ginger Beer', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🍺'),
    const BarPantryItem(id: 'ginger_ale', name: 'Ginger Ale doux', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🥤'),
    const BarPantryItem(id: 'ft_ginger_ale', name: 'Fever-Tree Premium Ginger Ale', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🥤'),
    const BarPantryItem(id: 'soda_water', name: 'Eau gazeuse / Club Soda', category: PantryCategory.mixers, unit: 'bouteilles', emoji: '💧'),
    const BarPantryItem(id: 'ft_soda_water', name: 'Fever-Tree Premium Soda Water', category: PantryCategory.mixers, unit: 'bouteilles', emoji: '💧'),
    const BarPantryItem(id: 'cola', name: 'Cola artisanal', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🥤'),
    const BarPantryItem(id: 'ft_cola', name: 'Fever-Tree Madagascan Cola', category: PantryCategory.mixers, unit: 'bouteilles / canettes', emoji: '🥤'),
    const BarPantryItem(id: 'lemonade', name: 'Limonade artisanale', category: PantryCategory.mixers, unit: 'bouteilles', emoji: '🍋'),
    const BarPantryItem(id: 'ft_lemonade', name: 'Fever-Tree Sicilian Lemonade', category: PantryCategory.mixers, unit: 'bouteilles', emoji: '🍋'),
